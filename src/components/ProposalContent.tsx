        ...
        <div className="space-y-6">
          ...
          {proposalMeta.paymentSchedule ? (
            <div className="bg-green-950/20 border border-green-800/30 rounded-xl p-5 mb-4">
              ...
              <div className="overflow-hidden rounded-lg border border-green-900/30">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-[#0d1117] text-left">
                      <th className="px-4 py-2 text-[10px] uppercase tracking-wider text-green-500 font-semibold">
                        #
                      </th>
                      <th className="px-4 py-2 text-[10px] uppercase tracking-wider text-green-500 font-semibold">
                        Date
