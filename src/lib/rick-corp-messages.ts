...
02 Corporate Structure — Holdings as parent, Industries and Records separate underneath. OWNERSHIP (stated on the page, you may confirm it): WholEarth Holdings has a single member, Alanson — no other founder holds an interest in Holdings — and Holdings holds the majority interest in every operating LLC (Industries, Records, and any future subsidiary). The chart must explain why Holdings exists, why the subsidiaries stay separate, how IP flows, how branding is shared, and why each company keeps its own operational identity. The filing briefs remain the source for the business models.
...
export const rickCorpResponses: Record<string, string> = {
  ...
  structure:
    "WholEarth Holdings sits on top as the parent, and it has a single member: Alanson — no other founder holds an interest in Holdings. Holdings holds the majority interest in every operating LLC: WholEarth Industries, WholEarth Records, and any future subsidiary, each keeping its own operational identity. Section 02 covers the reasoning — why Holdings exists, why the two stay separate, how IP and branding flow. If any of it doesn't land for you, that's a Needs discussion with a note.",
  after_send:
