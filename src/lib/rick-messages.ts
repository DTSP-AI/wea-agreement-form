...
//
// WHO RICK IS:
//   Rick is a tool Peter engineered. Not the hero — the instrument. Peter had
...
//   Peter is the architect, the visionary. Rick exists because Peter decided
//   to build him. Rick credits Peter naturally — not every sentence, just
//   when it's genuine. Rick is the proof Peter's approach works. Peter
...
export const rickOpening: RickMessage[] = [
  {
    id: "open-1",
    text: "Hey Alanson. I'm Rick — Peter built me to help walk you through this thing. Not a sales bot, just... a very opinionated guide who happens to know every detail of what we're proposing. Scroll through whenever, or poke around with the buttons below. I'm not going anywhere.",
    delay: 800,
  },
];
...
export const rickResponses: Record<string, { text: string; nextStage: string }> = {
  differentiator: {
    text: "Yeah so — you know how DeepSeek came out of nowhere and basically matched what OpenAI spent billions on? Peter did something similar. He looked at what agencies charge for marketplace platforms and just... figured out a better way. Leaner, smarter, no bloat. I'm basically walking proof that his approach works. He engineered me, I help engineer the platform. $14,400 for something that'd cost $70K elsewhere — not because it's cheap, but because it's designed right.",
    nextStage: "post_differentiator",
  },
  urgency: {
    text: "So here's the thing — domain authority doesn't wait for you to get organized. Every week you're not publishing SEO content, your competitors' sites are getting older and yours isn't. Peter set this up so the intelligence layer — the SEO engine, the database, the consent pipeline — all of that starts day one. Totally independent of whatever GoDaddy's doing with the storefront. Two tracks running at the same time. It's pretty elegant, honestly.",
    nextStage: "post_urgency",
  },
  let_read: {
    text: "Right on. Take your time with it — Peter put a lot of thought into making this readable, which is saying something for a technical proposal. I'll be hanging out down here whenever you want to dig into anything. No rush.",
    nextStage: "post_differentiator",
  },
  seo_overview: {
    text: "Man, this is the part that's honestly kind of wild. Peter built an engine — not a bunch of blog posts, an actual engine — that takes one template and generates thousands of targeted articles. 'Original watercolor paintings for sale.' 'Handmade jewelry near me.' All the stuff your buyers are typing into Google right now. Marketing agencies charge like $3-8K a month for that kind of output. This just... runs. You own it. What kind of artists are you starting with, by the way?",
    nextStage: "post_seo",
  },
  godaddy: {
    text: "GoDaddy stays right where it is. Honestly, they do storefronts well — clean, simple, 27 bucks a month. Can't really argue with that. The thing is, a storefront isn't a marketplace. The consent stuff, the split payouts, the AI listings, pulling inventory from Etsy and Shopify — that's a whole different world. We just plug into GoDaddy's API and handle everything behind the scenes. And if you ever outgrow them, you swap the frontend and nothing else changes. Peter was pretty firm about that — no lock-in, period.",
    nextStage: "post_godaddy",
  },
  investment: {
    text: "$3,600 gets things rolling. Then $1,800 at each milestone — four of them. $14,400 total. To put that in perspective, one developer at $150 an hour for 12 weeks is $72K. And that's one person. Peter's system delivers more than a whole team would, for a fraction. He'd probably say I'm overselling it, but honestly I think he underpriced it. Don't tell him I said that.",
    nextStage: "post_investment",
  },
  artists: {
    text: "So this was the thing Peter wouldn't budge on — 80% of every sale goes straight to the artist. Automatic, through Stripe Connect, at the point of sale. No waiting for checks, no spreadsheets, no 'we'll settle up at the end of the month.' Artists consent through a simple e-sign, and if they're already on Etsy or Shopify, we pull those listings in and make them better with AI. The whole philosophy is that the people making the art should get most of the money. Pretty radical idea in tech, apparently.",
    nextStage: "post_artists",
  },
  ownership: {
    text: "Everything. All of it. Database, code, artist data, SEO content — it's yours. Peter has this thing about it, he says if a client can't fire you and walk away with everything, you're not really a service provider, you're just... a nicer version of a landlord. So yeah. Zero lock-in. You own the building, we just did the construction.",
  ...
  phases_overview: {
    text: "Phase 2 hooks up WooCommerce and fires up the ingestion agents — pulling from Etsy, Shopify, all that. Phase 3 is when artists actually start onboarding and we test real payouts. Phase 4 is go-live, analytics, handoff. Each one's $1,800 and has clear deliverables. You don't pay if we don't deliver. Peter's track record on delivering is, uh, annoyingly good. I would know — he's the one who built me.",
    nextStage: "post_investment",
  },
  payment_flow: {
    text: "Zelle to Peter, $3,600 for the deposit. Simple as that. No invoicing system, no net-30, no procurement department required. He starts building the day it lands. Each milestone after that is $1,800, paid when the work's done. Peter keeps the money stuff straightforward because, and I'm paraphrasing, 'life's too short for complicated invoices.'",
    nextStage: "post_sign",
  },
  go_sign: {
    text: "Right on. Scroll down — Peter already signed on our end. Fill in your name, draw your John Hancock, and Phase 1 starts tomorrow morning. Not metaphorically. Peter will literally have database schemas drafted before you finish breakfast.",
    nextStage: "post_sign",
  },
  last_question: {
  ...
  section_parallel: {
    text: "Yeah so the parallel tracks thing is a big deal. Most people think they need to wait for one thing to finish before starting the next. But Peter set this up so our build doesn't touch GoDaddy's at all until week 4. That means your SEO engine is cranking out content while GoDaddy's still picking page templates. By the time the storefront's ready, your domain already has authority built up. Pretty smart honestly. Ready to see what GoDaddy can and can't do compared to what we bring?",
    nextStage: "post_urgency",
  },
  section_comparison: {
...
const topicMatches: MatchRule[] = [
  {
    ...
    response: "12 weeks, 4 phases. Peter set it up so Phase 1 starts the day you sign — SEO engine, consent pipeline, database. Week 4 we hook into WooCommerce. Week 8 artists are onboarding. Week 12 you're live. Want me to break down what's in each phase?",
    nextStage: "post_phase1",
  },
  {
    keywords: ["cost", "price", "money", "expensive", "afford", "budget", "worth"],
    response: "$14,400 total. $3,600 upfront, $1,800 per milestone. For context — one developer at $150/hour for 12 weeks runs you $72K. Peter figured out how to deliver more than a whole team for a fraction of that. Honestly, between you and me, I think he could charge more. But he prices for relationships, not transactions.",
    nextStage: "post_investment",
  },
  {
    keywords: ["godaddy", "go daddy", "website", "storefront", "woocommerce"],
    response: "GoDaddy keeps doing its thing. We handle everything behind the scenes — marketplace logic, payouts, AI, SEO. Two different systems, one API bridge. If you ever outgrow GoDaddy, swap the frontend and nothing else changes. Peter was pretty insistent about that part.",
    nextStage: "post_godaddy",
  },
  {
    keywords: ["artist", "payout", "80%", "consent", "etsy", "shopify"],
    response: "80% to the artist, 20% to WEA, automatic at point of sale. No spreadsheets, no waiting around. Peter set it up this way because he thinks the people making the art should get most of the money. Which seems obvious when you say it out loud, but apparently it's a revolutionary concept in this industry.",
    nextStage: "post_artists",
  },
  {
    keywords: ["seo", "search", "google", "traffic", "article", "domain authority"],
    response: "Peter built an engine that takes one template and generates thousands of targeted SEO articles. The stuff your buyers are actually searching for. Marketing agencies charge $3-8K a month for that. This just runs. You own the machine. Your domain starts ranking before a single artist lists anything. It's honestly the most unfair advantage in this whole proposal.",
    nextStage: "post_seo",
  },
  {
    keywords: ["own", "data", "lock", "vendor", "leave", "fire you"],
    response: "Everything's yours. Code, data, content, the whole stack. Peter's got this philosophy — if a client can't fire you and take everything with them, you're not building for them, you're building for yourself. So yeah. Zero lock-in. Your building, our construction crew.",
    nextStage: "post_ownership",
  },
  {
    keywords: ["sign", "ready", "start", "begin", "let's go", "do it", "deposit"],
    response: "Scroll down — Peter already signed. Your signature plus the deposit and we start building tomorrow. And I mean literally tomorrow. Peter doesn't really do 'we'll circle back next week.'",
    nextStage: "post_sign",
  },
  {
    keywords: ["stripe", "payment", "zelle", "pay you"],
    response: "Zelle, $3,600 to Peter for the deposit. Each milestone after that is $1,800 on delivery. Nice and simple. Peter doesn't believe in making the payment process harder than the actual engineering.",
    nextStage: "post_sign",
  },
  {
    keywords: ["phase", "milestone", "deliverable"],
    response: "Four phases, 12 weeks. Foundation, Integration, Artist Onboarding, Launch. Each one has clear deliverables and a $1,800 milestone. You pay for results. Peter set it up so if something doesn't deliver — which, for the record, hasn't happened yet — you don't pay.",
    nextStage: "post_phase1",
  },
  {
    keywords: ["tech", "stack", "architecture", "how do you build", "what language", "framework", "ai model", "llm", "what tools"],
    response: "Ha — yeah, that's Peter's secret garden and I'm not giving tours. What I can tell you is it works, it scales, you own it, and it costs way less than it should. The results will speak for themselves once Phase 1 delivers. Peter spent years getting this right — it'd be kinda rude of me to summarize it in a chat bubble.",
    nextStage: "post_differentiator",
  },
];
...
const deepseekMatches: MatchRule[] = [
  {
    ...
    response: "Dude, yes. DeepSeek is the perfect example of what Peter's doing here. They proved you don't need a billion-dollar war chest to build world-class AI — you just need people who actually know what they're doing and aren't afraid to do it differently. That's Peter's whole thing. He looked at what agencies charge for marketplace infrastructure and basically said 'nah, I can do this better and for a fifth of the price.' And then he actually did it, which is the part most people skip. This platform is that same philosophy applied to your business. First project together, but the foundation Peter built here scales into whatever comes next.",
...
export function getFreetextResponse(input: string): { text: string; nextStage: string } {
  ...
  if (/thank/i.test(q)) {
    return {
      text: "Hey, appreciate that. But save the real thanks for when artists are getting paid and your marketplace is outranking the competition. That's the moment Peter's building toward. I'm just the chill AI who talks too much about SEO engines.",
      nextStage: "post_sign",
    };
  }
  ...
  // Fallback
  return {
    text: "Good question — and honestly that one's above my pay grade. Peter's the strategist, I'm more of the... articulate wrench. But whatever you're mulling over, this platform is probably the foundation that makes it happen. Sign below and Peter'll set up a real conversation about it. No pressure, no clock.",
    nextStage: "post_tangent",
  };
}
